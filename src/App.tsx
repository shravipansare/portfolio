    ...
    <>
      ...
      <main>
          ...
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-100px" }} variants={fadeInUp}>
            ...
            <div className="bento-grid max-w-5xl mx-auto">
              ...
              <div className="glass-panel bento-item bento-span-4 flex flex-col justify-center items-center text-center">
                <Award className="w-16 h-16 text-[#8fbc8f] mb-4" />
              ...
              <div className="glass-panel bento-item bento-span-6">
                <div className="flex items-start gap-4">
                  <div className="p-4 bg-[rgba(143,188,143,0.1)] rounded-2xl border border-[rgba(143,188,143,0.2)]">
                    <GraduationCap className="text-[#8fbc8f] w-8 h-8" />
                  </div>
                  <div>
                    ...
                    <span className="text-xs font-bold text-[#8fbc8f] bg-[rgba(143,188,143,0.1)] px-3 py-1.5 rounded-full tracking-wide">2024 - 2027</span>
                  </div>
                </div>
              </div>
              ...
              <div className="glass-panel bento-item bento-span-6">
                <div className="flex items-start gap-4">
                  <div className="p-4 bg-[rgba(212,175,55,0.1)] rounded-2xl border border-[rgba(212,175,55,0.2)]">
                  ...
                  <div>
                    ...
                    <span className="text-xs font-bold text-[#d4af37] bg-[rgba(212,175,55,0.1)] px-3 py-1.5 rounded-full tracking-wide">2021 - 2024 (86.53%)</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeInUp}>
            ...
            <motion.div className="bento-grid max-w-5xl mx-auto" variants={staggerContainer}>
              <motion.div className="glass-panel bento-item bento-span-12 md:bento-span-4" variants={fadeInUp}>
                <h3 className="text-xl font-bold mb-6 flex items-center gap-3 text-white"><Code className="text-[#8fbc8f] w-6 h-6"/> Languages & Web</h3>
              ...
              <motion.div className="glass-panel bento-item bento-span-12 md:bento-span-8" variants={fadeInUp}>
                <h3 className="text-xl font-bold mb-6 flex items-center gap-3 text-white"><Monitor className="text-[#d4af37] w-6 h-6"/> Machine Learning & AI</h3>
                <div className="flex flex-wrap gap-2">
              ...
              <motion.div className="glass-panel bento-item bento-span-12" variants={fadeInUp}>
                <h3 className="text-xl font-bold mb-6 flex items-center gap-3 text-white"><Briefcase className="text-[#a0aab2] w-6 h-6"/> Databases & Tools</h3>
                <div className="flex flex-wrap gap-2">
          ...
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeInUp}>
            ...
            <div className="timeline-container">
              <motion.div className="timeline-item" variants={fadeInUp}>
                <div className="glass-panel p-8 border-l-4 border-l-[#8fbc8f]">
                  <span className="font-mono text-[#8fbc8f] text-sm font-bold tracking-widest uppercase mb-2 block">May 2026 - Present</span>
                  <h3 className="text-2xl font-bold mb-2 text-white flex items-center gap-3">Product Engineer Intern <span className="bg-[rgba(143,188,143,0.1)] border border-[rgba(143,188,143,0.2)] text-[#8fbc8f] text-[10px] px-2 py-1 rounded-full uppercase tracking-widest font-bold">Latest</span></h3>
                  <p className="text-[#a1a1aa] font-medium mb-6 text-lg">MartechAdda</p>
                  <ul className="space-y-4 text-[#d4d4d8]">
                    <li className="flex items-start gap-3"><div className="w-1.5 h-1.5 rounded-full bg-[#8fbc8f] shadow-[0_0_10px_#8fbc8f] flex-shrink-0 mt-2.5"/> Conducted comprehensive UI/UX analysis and QA testing for MartechAdda V4, identifying critical usability improvements and system bugs.</li>
                    <li className="flex items-start gap-3"><div className="w-1.5 h-1.5 rounded-full bg-[#8fbc8f] shadow-[0_0_10px_#8fbc8f] flex-shrink-0 mt-2.5"/> Architected and developed "Ledgerly", a modern B2B invoicing and CRM SaaS platform using React, Node.js, Express, and MongoDB.</li>
                    <li className="flex items-start gap-3"><div className="w-1.5 h-1.5 rounded-full bg-[#8fbc8f] shadow-[0_0_10px_#8fbc8f] flex-shrink-0 mt-2.5"/> Integrated enterprise-grade features including Razorpay payment gateways, NodeMailer SMTP automation, and 2FA security.</li>
                  </ul>
                </div>
              </motion.div>

              <motion.div className="timeline-item" variants={fadeInUp}>
                <div className="glass-panel p-8 border-l-4 border-l-[#d4af37]">
                  <span className="font-mono text-[#d4af37] text-sm font-bold tracking-widest uppercase mb-2 block">Dec 2023 - Jan 2024</span>
                  ...
                  <ul className="space-y-4 text-[#d4d4d8]">
                    <li className="flex items-start gap-3"><div className="w-1.5 h-1.5 rounded-full bg-[#d4af37] shadow-[0_0_10px_#d4af37] flex-shrink-0 mt-2.5"/> Built and trained supervised ML models (Decision Tree, Random Forest, SVM) on real-world datasets for classification and regression tasks.</li>
                    <li className="flex items-start gap-3"><div className="w-1.5 h-1.5 rounded-full bg-[#d4af37] shadow-[0_0_10px_#d4af37] flex-shrink-0 mt-2.5"/> Performed end-to-end data preprocessing: handled missing values, feature scaling, label encoding, and train-test splitting.</li>
                  </ul>
                </div>
              </motion.div>

              <motion.div className="timeline-item" variants={fadeInUp}>
                <div className="glass-panel p-8 border-l-4 border-l-[#a0aab2]">
                  <span className="font-mono text-[#a0aab2] text-sm font-bold tracking-widest uppercase mb-2 block">Jun 2023 - Aug 2023</span>
                  ...
                  <ul className="space-y-4 text-[#d4d4d8]">
                    <li className="flex items-start gap-3"><div className="w-1.5 h-1.5 rounded-full bg-[#a0aab2] shadow-[0_0_10px_#a0aab2] flex-shrink-0 mt-2.5"/> Developed and debugged applications using Java, Python, JavaScript, HTML, and CSS.</li>
                    <li className="flex items-start gap-3"><div className="w-1.5 h-1.5 rounded-full bg-[#a0aab2] shadow-[0_0_10px_#a0aab2] flex-shrink-0 mt-2.5"/> Designed and managed databases with SQL Server and MongoDB, improving performance and reliability.</li>
                    <li className="flex items-start gap-3"><div className="w-1.5 h-1.5 rounded-full bg-[#a0aab2] shadow-[0_0_10px_#a0aab2] flex-shrink-0 mt-2.5"/> Collaborated in team discussions and conducted code reviews to ensure code quality.</li>
                  </ul>
                </div>
              </motion.div>
            </div>
          ...
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeInUp}>
            ...
            <div className="grid-2">
              <motion.div className="glass-panel flex flex-col p-8" variants={fadeInUp}>
                <div className="absolute top-0 right-0 bg-[#8fbc8f] text-black text-[10px] font-black tracking-widest px-4 py-1.5 rounded-bl-xl uppercase">SaaS App</div>
                ...
                <p className="font-mono text-[#8fbc8f] text-xs font-bold tracking-widest uppercase mb-6">2026 • Full Stack</p>
              ...
              <motion.div className="glass-panel flex flex-col p-8" variants={fadeInUp}>
                ...
                <p className="font-mono text-[#d4af37] text-xs font-bold tracking-widest uppercase mb-6 mt-1">2024 - 2025 • Computer Vision</p>
                <ul className="space-y-3 text-[#d4d4d8] mb-8 flex-grow">
              ...
              <motion.div className="glass-panel flex flex-col p-8" variants={fadeInUp}>
                ...
                <p className="font-mono text-[#a0aab2] text-xs font-bold tracking-widest uppercase mb-6 mt-1">2023 - 2024 • AI / ML</p>
                <ul className="space-y-3 text-[#d4d4d8] mb-8 flex-grow">
              ...
              <motion.div className="glass-panel flex flex-col p-8" variants={fadeInUp}>
                ...
                <p className="font-mono text-[#8fbc8f] text-xs font-bold tracking-widest uppercase mb-6 mt-1">2026 • Backend Architecture</p>
                <ul className="space-y-3 text-[#d4d4d8] mb-8 flex-grow">
        ...
        <section id="certifications" className="section container">
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeInUp}>
            ...
            <div className="bento-grid max-w-5xl mx-auto">
              {/* Award */}
              <div className="glass-panel bento-item bento-span-12 md:bento-span-6 bg-gradient-to-br from-[rgba(212,175,55,0.05)] to-transparent border-[rgba(212,175,55,0.2)]">
                <div className="flex items-start gap-5">
                  ...
                  <div>
                    ...
                    <span className="text-xs font-bold text-[#d4af37] bg-[rgba(212,175,55,0.1)] px-3 py-1.5 rounded-full tracking-wide">2025</span>
                  </div>
                </div>
              </div>
              ...
              <div className="glass-panel bento-item bento-span-12 md:bento-span-6">
                <div className="flex items-start gap-5">
                  <div className="p-4 bg-[rgba(143,188,143,0.1)] rounded-2xl border border-[rgba(143,188,143,0.2)]">
                    <FileText className="text-[#8fbc8f] w-8 h-8" />
                  </div>
                  <div>
                    ...
                    <span className="text-xs font-bold text-[#8fbc8f] bg-[rgba(143,188,143,0.1)] px-3 py-1.5 rounded-full tracking-wide">June 2026</span>
                  </div>
                </div>
              </div>
              ...
              <div className="glass-panel bento-item bento-span-12 md:bento-span-6 md:col-start-4">
                <div className="flex items-start gap-5">
                  <div className="p-4 bg-[rgba(160,170,178,0.1)] rounded-2xl border border-[rgba(160,170,178,0.2)]">
                    <FileText className="text-[#a0aab2] w-8 h-8" />
                  </div>
                  <div>
                    ...
                    <span className="text-xs font-bold text-[#a0aab2] bg-[rgba(160,170,178,0.1)] px-3 py-1.5 rounded-full tracking-wide">June 2026</span>
                  </div>
                </div>
              </div>
            </div>
        ...
        <section id="contact" className="section container">
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeInUp} className="max-w-2xl mx-auto text-center">
            ...
            <div className="glass-panel p-8 max-w-md mx-auto flex flex-col items-center gap-6 border-t-4 border-t-[#8fbc8f]">
              <div className="flex items-center text-white font-bold text-lg gap-3">
                <MapPin className="w-6 h-6 text-[#8fbc8f]"/> Baramati, Pune
              </div>
              <div className="flex justify-center gap-8 mt-2 w-full pt-6 border-t border-[rgba(255,255,255,0.1)]">
                ...
                <a href="https://linkedin.com/in/shravani-pansare-46331830a" target="_blank" rel="noreferrer" className="text-secondary hover:text-[#8fbc8f] hover:scale-110 transition-all">
      ...
      <footer>
        <div className="container">
          <p className="text-white font-bold tracking-widest uppercase text-sm mb-4">Built with <span className="text-[#8fbc8f]">React</span> & <span className="text-[#d4af37]">Framer Motion</span></p>
